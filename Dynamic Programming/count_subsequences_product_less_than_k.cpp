// CPP program to find number of subarrays having product less than k.
#include <bits/stdc++.h>
using namespace std;
...
int productSubSeqCount(vector<int> &arr, int k)
{
    int n = arr.size();
    int dp[k + 1][n + 1];
    // here dp[i][j] represents no. of subsequences with first j no. of elements and having product less than i
